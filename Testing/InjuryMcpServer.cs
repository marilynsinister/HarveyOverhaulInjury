...
namespace HarveyOverhaul.InjuryCare.Testing
{
    ...
    internal static class InjuryMcpTools
    {
        public static readonly object[] All =
        {
            ...
            Tool("injury_mine_forbidden_clear", "Clear hard mine forbidden (HarveyMod_MineForbidden)."),
            Tool("injury_mine_clear", "Clear mine forbidden + restricted and strike counters."),
            Tool("injury_mine_forbid", "Apply MineForbidden for QA.",
                Prop("days", "integer", "Days left (default MineForbiddenDurationDays)")),
            Tool("injury_mine_restriction_clear", "Clear soft mine restriction (HarveyMod_MineRestricted) and strike counters."),
            Tool("injury_mine_status", "Report mine forbidden/restricted mode, strikes, severe injuries."),
            Tool("injury_mine_forbidden_status", "Alias for injury_mine_status."),
            ...
            Tool("injury_hospital_progress", "Set hospital stay progress minutes (QA).",
                Prop("minutes", "integer", "Accumulated hospital stay minutes")),
            Tool("injury_hospital_reset", "Reset hospitalization state and buff."),
